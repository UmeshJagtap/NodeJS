// ( ATLAS STARTER NODE ) -https://github.com/mongodb-university/atlas_starter_nodejs/blob/master/app.js
...
async function run() {
  ...
  const uri =
    'mongodb+srv://umeshjagtap7866:4wMVMO3mJsQ2NqJ4@cluster0.anqg4ks.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
// ZUK@DESKTOP-0M6F0IP MINGW64 ~/Documents/GitHub/NodeJS/task-manager/src/db (main)
// $ node atlas_starter_node.js
// 4 documents successfully inserted.

// elotes has 5 ingredients and takes 35 minutes to make.
// fried rice has 7 ingredients and takes 40 minutes to make.

// Found a recipe with 'potato' as an ingredient:
// {"_id":"65f9a652f29d7fff047252f3","name":"patatas bravas","ingredients":["potato","tomato","olive oil","onion","garlic","paprika"],"prepTimeInMinutes":80}
